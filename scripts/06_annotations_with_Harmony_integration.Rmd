---
title: "annotations before doublet removal to remove noise clusters"
...
```{r read_object}
# read object
dataObject <- readRDS(file = paste0("../rObjects/PMI_unannotated_integrated.rds"))
# inspect
dataObject
