...
pdf(
  paste0(
    ...
    treatment,
    "_seurat_clusters_UMAP_doublets_removed.pdf"
  ),
  width = 11,
  height = 7
)
...
write.table(markers, 
            paste0("../results/markers/", treatment, "_markers_doublets_removed.tsv"),
            quote = FALSE,
            row.names = FALSE)
saveRDS(markers, paste0("../rObjects/", treatment, "_markers_doublets_removed..rds"))
...
saveRDS(all.markers.strict, paste0("../rObjects/", treatment,"_markers_log2FC1_q0.01_doublets_removed.rds"))
```
...
pdf(
  paste0(
    "../results/dot_plot/",
    treatment,
    "_clusters_DotPlot_no_integration_doublets_removed_order_by_cluster.pdf"
  ),
  width = 14,
  height = 10
)
...
pdf(
  paste0(
    ...
    treatment,
    "_individual_clusters_UMAP_doublets_removed.pdf"
  ),
  width = 11,
  height = 7
)
...
pdf(
  paste0(
    "../results/UMAP/annotated/",
    treatment,
    "_individual_clusters_nuclei_count_doublets_removed.pdf"
  ),
  width = 11,
  height = 7
)
...
pdf(
  paste0(
    "../results/UMAP/annotated/",
    treatment,
    "_merged_clusters_relative_abundance_doublets_removed.pdf"
  ),
  width = 6,
  height = 8
)
...
# Save RDS 
```{r save_annotations}
saveRDS(dataObject.annotated, paste0("../rObjects/", treatment, ".annotated.doubletsRemoved.rds"))
```
