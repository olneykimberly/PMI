...
dataObject.pseudo <- AggregateExpression(
    ...
    assays = "RNA", 
    return.seurat = TRUE, 
    group.by = c("sample", "strain", "sex", "individual_clusters")
)
...
correlation_matrix <- cor(combined_data[, 1:10], combined_data[, c("sex", "strain", "time", "individual_clusters")])
...
DimPlot(dataObject.pseudo, reduction = "pca", group.by = "individual_clusters")
#DimPlot(dataObject.pseudo, reduction = "pca", group.by = "sex", dims = c(3,4))
