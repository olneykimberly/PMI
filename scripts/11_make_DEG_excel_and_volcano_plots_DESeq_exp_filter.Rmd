...
for (i in cell_types) {
  ...
  if (!any(ind1_vs_ind2$padj < 0.1, na.rm = TRUE)) {
    ...
    pdf(paste0("../results/volcanoes/DESeq2_pseudobulk_exp_filter/", i, "_3_vs_0hours_all_samples.pdf"), height = 8, width = 8)
    print(p)
    dev.off()
  } else {
    color_values <- vector()
...
for (i in cell_types) {
  ind1_vs_ind2 <- read.delim(paste0("../results/DEGs/DESeq2_pseudobulk_exp_filter/", i, "_3_vs_0_hours_comparison_XX_female_only.txt"))
  ind1_vs_ind2 <- na.omit(ind1_vs_ind2)
  if (!any(ind1_vs_ind2$padj < 0.1, na.rm = TRUE)) {
    # If there are no significant DEGs, create a volcano plot with all points in gray
    p <- ggplot(data = ind1_vs_ind2, aes(x = log2FoldChange, y = -log10(pvalue))) +
    ...
    pdf(paste0("../results/volcanoes/DESeq2_pseudobulk_exp_filter/", i, "_3_vs_0hours_XX_female_only.pdf"), height = 8, width = 8)
    print(p)
    dev.off()
  } else {
    color_values <- vector()
...
for (i in cell_types) {
  ind1_vs_ind2 <- read.delim(paste0("../results/DEGs/DESeq2_pseudobulk_exp_filter/",i,  "_3_vs_0_hours_comparison_XY_male_only.txt"))
  ind1_vs_ind2 <- na.omit(ind1_vs_ind2)
  if (!any(ind1_vs_ind2$padj < 0.1, na.rm = TRUE)) {
    # If there are no significant DEGs, create a volcano plot with all points in gray
    p <- ggplot(data = ind1_vs_ind2, aes(x = log2FoldChange, y = -log10(pvalue))) +
    ...
    pdf(paste0("../results/volcanoes/DESeq2_pseudobulk_exp_filter/", i, "_3_vs_0hours_XY_male_only.pdf"), height = 8, width = 8)
    print(p)
    dev.off()
  } else {
    color_values <- vector()
...
for (i in cell_types) {
  ind1_vs_ind2 <- read.delim(paste0("../results/DEGs/DESeq2_pseudobulk_exp_filter/",i,  "_3_vs_0_hours_comparison_PS19_only.txt"))
  ind1_vs_ind2 <- na.omit(ind1_vs_ind2)
  if (!any(ind1_vs_ind2$padj < 0.1, na.rm = TRUE)) {
    # If there are no significant DEGs, create a volcano plot with all points in gray
    p <- ggplot(data = ind1_vs_ind2, aes(x = log2FoldChange, y = -log10(pvalue))) +
    ...
    pdf(paste0("../results/volcanoes/DESeq2_pseudobulk_exp_filter/", i, "_3_vs_0hours_PS19_only.pdf"), height = 8, width = 8)
    print(p)
    dev.off()
  } else {
    color_values <- vector()
...
for (i in cell_types) {
  ind1_vs_ind2 <- read.delim(paste0("../results/DEGs/DESeq2_pseudobulk_exp_filter/",i,  "_3_vs_0_hours_comparison_WT_only.txt"))
  ind1_vs_ind2 <- na.omit(ind1_vs_ind2)
  if (!any(ind1_vs_ind2$padj < 0.1, na.rm = TRUE)) {
    # If there are no significant DEGs, create a volcano plot with all points in gray
    p <- ggplot(data = ind1_vs_ind2, aes(x = log2FoldChange, y = -log10(pvalue))) +
    ...
    pdf(paste0("../results/volcanoes/DESeq2_pseudobulk_exp_filter/", i, "_3_vs_0hours_WT_only.pdf"), height = 8, width = 8)
    print(p)
    dev.off()
  } else {
    color_values <- vector()
...
for (i in cell_types) {
  ind1_vs_ind2 <- read.delim(paste0("../results/DEGs/DESeq2_pseudobulk_exp_filter/", i, "_PS19_vs_WT_comparison_pseudobulk.txt"))
  ind1_vs_ind2 <- na.omit(ind1_vs_ind2)
  if (!any(ind1_vs_ind2$padj < 0.1, na.rm = TRUE)) {
    # If there are no significant DEGs, create a volcano plot with all points in gray
    p <- ggplot(data = ind1_vs_ind2, aes(x = log2FoldChange, y = -log10(pvalue))) +
    ...
    pdf(paste0("../results/volcanoes/DESeq2_pseudobulk_exp_filter/", i, "_PS19_vs_WT_all_samples.pdf"), height = 8, width = 8)
    print(p)
    dev.off()
  } else {
    color_values <- vector()
...
for (i in cell_types) {
  ...
  if (!any(ind1_vs_ind2$padj < 0.1, na.rm = TRUE)) {
    ...
    pdf(paste0("../results/volcanoes/DESeq2_pseudobulk_exp_filter/", i, "_PS19_vs_WT_3hours_only.pdf"), height = 8, width = 8)
    print(p)
    dev.off()
  } else {
    color_values <- vector()
...
for (i in cell_types) {
  ...
  if (!any(ind1_vs_ind2$padj < 0.1, na.rm = TRUE)) {
    ...
    pdf(paste0("../results/volcanoes/DESeq2_pseudobulk_exp_filter/", i, "_PS19_vs_WT_0hours_only.pdf"), height = 8, width = 8)
    print(p)
    dev.off()
  } else {
    color_values <- vector()
...
write.xlsx(list_of_datasets, file = paste0(
    "../results/DEGs/DESeq2_pseudobulk_exp_filter/3_vs_0_hours.xlsx"))
...
# XX female only 
for (i in cell_types) {
  filepath <- paste0("../results/DEGs/DESeq2_pseudobulk_exp_filter/", i, "_3_vs_0_hours_comparison_XX_female_only.txt")
  assign(paste0(i), read.delim(filepath, header = TRUE, sep = "\t", stringsAsFactors = FALSE))
}
...
"microglia" = microglia)
write.xlsx(list_of_datasets, file = paste0(
    "../results/DEGs/DESeq2_pseudobulk_exp_filter/3_vs_0_hours_XX_female_only.xlsx"))
...
# XY male only 
for (i in cell_types) {
  filepath <- paste0("../results/DEGs/DESeq2_pseudobulk_exp_filter/", i, "_3_vs_0_hours_comparison_XY_male_only.txt")
  assign(paste0(i), read.delim(filepath, header = TRUE, sep = "\t", stringsAsFactors = FALSE))
}
...
"microglia" = microglia)
write.xlsx(list_of_datasets, file = paste0(
    "../results/DEGs/DESeq2_pseudobulk_exp_filter/3_vs_0_hours_XY_male_only.xlsx"))
...
"microglia" = microglia)
write.xlsx(list_of_datasets, file = paste0(
    "../results/DEGs/DESeq2_pseudobulk_exp_filter/3_vs_0_hours_WT_only.xlsx"))
...
"microglia" = microglia)
write.xlsx(list_of_datasets, file = paste0(
    "../results/DEGs/DESeq2_pseudobulk_exp_filter/3_vs_0_hours_PS19_only.xlsx"))
...
"microglia" = microglia)
write.xlsx(list_of_datasets, file = paste0(
    "../results/DEGs/DESeq2_pseudobulk_exp_filter/PS19_vs_WT.xlsx"))
...
# XX female only 
for (i in cell_types) {
  filepath <- paste0("../results/DEGs/DESeq2_pseudobulk_exp_filter/", i, "_PS19_vs_WT_comparison_XX_female_only.txt")
  assign(paste0(i), read.delim(filepath, header = TRUE, sep = "\t", stringsAsFactors = FALSE))
}
...
"microglia" = microglia)
write.xlsx(list_of_datasets, file = paste0(
    "../results/DEGs/DESeq2_pseudobulk_exp_filter/PS19_vs_WT_XX_female_only.xlsx"))
...
# XY male only 
for (i in cell_types) {
  filepath <- paste0("../results/DEGs/DESeq2_pseudobulk_exp_filter/", i, "_PS19_vs_WT_comparison_XY_male_only.txt")
  assign(paste0(i), read.delim(filepath, header = TRUE, sep = "\t", stringsAsFactors = FALSE))
}
...
"microglia" = microglia)
write.xlsx(list_of_datasets, file = paste0(
    "../results/DEGs/DESeq2_pseudobulk_exp_filter/PS19_vs_WT_XY_male_only.xlsx"))
...
"microglia" = microglia)
write.xlsx(list_of_datasets, file = paste0(
    "../results/DEGs/DESeq2_pseudobulk_exp_filter/PS19_vs_WT_3hours_only.xlsx"))
...
"microglia" = microglia)
write.xlsx(list_of_datasets, file = paste0(
    "../results/DEGs/DESeq2_pseudobulk_exp_filter/PS19_vs_WT_0hours_only.xlsx"))
...
for (i in cell_types) {
  ...
  filtered_dataset <- subset(dataset, padj < 0.1 & log2FoldChange > 0)
  list_of_datasets[[i]] <- filtered_dataset
}
write.xlsx(list_of_datasets, file = paste0(
    "../results/DEGs/DESeq2_pseudobulk_exp_filter/3_vs_0_hours_qval0.1_up_regulated.xlsx"))
...
write.xlsx(list_of_datasets, file = paste0(
    "../results/DEGs/DESeq2_pseudobulk_exp_filter/3_vs_0_hours_qval0.1_down_regulated.xlsx"))
...
write.xlsx(list_of_datasets, file = paste0(
    "../results/DEGs/DESeq2_pseudobulk_exp_filter/3_vs_0_hours_qval0.1_up_regulated_PS19_only.xlsx"))
...
write.xlsx(list_of_datasets, file = paste0(
    "../results/DEGs/DESeq2_pseudobulk_exp_filter/3_vs_0_hours_qval0.1_down_regulated_PS19_only.xlsx"))
...
write.xlsx(list_of_datasets, file = paste0(
    "../results/DEGs/DESeq2_pseudobulk_exp_filter/3_vs_0_hours_qval0.1_up_regulated_WT_only.xlsx"))
...
write.xlsx(list_of_datasets, file = paste0(
    "../results/DEGs/DESeq2_pseudobulk_exp_filter/3_vs_0_hours_qval0.1_down_regulated_WT_only.xlsx"))
```
...
write.xlsx(list_of_datasets, file = paste0(
    "../results/DEGs/DESeq2_pseudobulk_exp_filter/PS19_vs_WT_qval0.1_up_regulated.xlsx"))
...
write.xlsx(list_of_datasets, file = paste0(
    "../results/DEGs/DESeq2_pseudobulk_exp_filter/PS19_vs_WT_qval0.1_down_regulated.xlsx"))
...
write.xlsx(list_of_datasets, file = paste0(
    "../results/DEGs/DESeq2_pseudobulk_exp_filter/PS19_vs_WT_qval0.1_up_regulated_3hours_only.xlsx"))
...
write.xlsx(list_of_datasets, file = paste0(
    "../results/DEGs/DESeq2_pseudobulk_exp_filter/PS19_vs_WT_qval0.1_down_regulated_3hours_only.xlsx"))
...
write.xlsx(list_of_datasets, file = paste0(
    "../results/DEGs/DESeq2_pseudobulk_exp_filter/PS19_vs_WT_qval0.1_up_regulated_0hours_only.xlsx"))
...
write.xlsx(list_of_datasets, file = paste0(
  "../results/DEGs/DESeq2_pseudobulk_exp_filter/PS19_vs_WT_qval0.1_down_regulated_0hours_only.xlsx"))
```
...
count_DE_genes <- function(data) {
  return(sum(data$padj < 0.1 & abs(data$log2FoldChange) > 0, na.rm = TRUE))
}

# Loop through each cell type
for (cell_type in cell_types) {
  # File paths
  all_samples_file <- paste0("../results/DEGs/DESeq2_pseudobulk_exp_filter/", cell_type, "_PS19_vs_WT_comparison_pseudobulk.txt")
  hours_0_file <- paste0("../results/DEGs/DESeq2_pseudobulk_exp_filter/", cell_type, "_PS19_vs_WT_comparison_0_hours_only.txt")
  hours_3_file <- paste0("../results/DEGs/DESeq2_pseudobulk_exp_filter/", cell_type, "_PS19_vs_WT_comparison_3_hours_only.txt")
...
for (cell_type in cell_types) {
  # File paths
  all_samples_file <- paste0("../results/DEGs/DESeq2_pseudobulk_exp_filter/", cell_type, "_3_vs_0_hours_comparison_pseudobulk.txt")
  XX_file <- paste0("../results/DEGs/DESeq2_pseudobulk_exp_filter/", cell_type, "_3_vs_0_hours_comparison_XX_female_only.txt")
  XY_file <- paste0("../results/DEGs/DESeq2_pseudobulk_exp_filter/", cell_type, "_3_vs_0_hours_comparison_XY_male_only.txt")
...
for (cell_type in cell_types) {
  # File paths
  all_samples_file <- paste0("../results/DEGs/DESeq2_pseudobulk_exp_filter/", cell_type, "_3_vs_0_hours_comparison_pseudobulk.txt")
  PS19_file <- paste0("../results/DEGs/DESeq2_pseudobulk_exp_filter/", cell_type, "_3_vs_0_hours_comparison_PS19_only.txt")
  WT_file <- paste0("../results/DEGs/DESeq2_pseudobulk_exp_filter/", cell_type, "_3_vs_0_hours_comparison_WT_only.txt")
