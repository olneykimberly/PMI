...
for (i in cell_types) {
  ind1_vs_ind2 <- read.delim(paste0("../results/DEGs/MAST/", i, "_3_vs_0_hours_comparison.txt"))
...
for (i in cell_types) {
  ind1_vs_ind2 <- read.delim(paste0("../results/DEGs/MAST/", i, "_3_vs_0_hours_comparison_XX_female_only.txt"))
  ind1_vs_ind2 <- na.omit(ind1_vs_ind2)
  if (!any(ind1_vs_ind2$p_val_adj < 0.01, na.rm = TRUE)) {
    # If there are no significant DEGs, create a volcano plot with all points in gray
    p <- ggplot(data = ind1_vs_ind2, aes(x = avg_log2FC, y = -log10(p_val))) +
...
for (i in cell_types) {
  ind1_vs_ind2 <- read.delim(paste0("../results/DEGs/MAST/",i,  "_3_vs_0_hours_comparison_XY_male_only.txt"))
  ind1_vs_ind2 <- na.omit(ind1_vs_ind2)
  if (!any(ind1_vs_ind2$p_val_adj < 0.01, na.rm = TRUE)) {
    # If there are no significant DEGs, create a volcano plot with all points in gray
    p <- ggplot(data = ind1_vs_ind2, aes(x = avg_log2FC, y = -log10(p_val))) +
...
for (i in cell_types) {
  ind1_vs_ind2 <- read.delim(paste0("../results/DEGs/MAST/",i,  "_3_vs_0_hours_comparison_PS19_only.txt"))
  ind1_vs_ind2 <- na.omit(ind1_vs_ind2)
  if (!any(ind1_vs_ind2$p_val_adj < 0.01, na.rm = TRUE)) {
    # If there are no significant DEGs, create a volcano plot with all points in gray
    p <- ggplot(data = ind1_vs_ind2, aes(x = avg_log2FC, y = -log10(p_val))) +
...
for (i in cell_types) {
  ind1_vs_ind2 <- read.delim(paste0("../results/DEGs/MAST/",i,  "_3_vs_0_hours_comparison_WT_only.txt"))
  ind1_vs_ind2 <- na.omit(ind1_vs_ind2)
  if (!any(ind1_vs_ind2$p_val_adj < 0.01, na.rm = TRUE)) {
    # If there are no significant DEGs, create a volcano plot with all points in gray
    p <- ggplot(data = ind1_vs_ind2, aes(x = avg_log2FC, y = -log10(p_val))) +
...
for (i in cell_types) {
  ind1_vs_ind2 <- read.delim(paste0("../results/DEGs/MAST/", i, "_PS19_vs_WT_comparison.txt"))
  ind1_vs_ind2 <- na.omit(ind1_vs_ind2)
  if (!any(ind1_vs_ind2$p_val_adj < 0.01, na.rm = TRUE)) {
    # If there are no significant DEGs, create a volcano plot with all points in gray
    p <- ggplot(data = ind1_vs_ind2, aes(x = avg_log2FC, y = -log10(p_val))) +
...
```{r volcano_strain, warning=FALSE}
for (i in cell_types) {
  ind1_vs_ind2 <- read.delim(paste0("../results/DEGs/MAST/", i, "_PS19_vs_WT_comparison_3hours_only.txt"))
  ind1_vs_ind2 <- na.omit(ind1_vs_ind2)
  if (!any(ind1_vs_ind2$p_val_adj < 0.01, na.rm = TRUE)) {
    # If there are no significant DEGs, create a volcano plot with all points in gray
    p <- ggplot(data = ind1_vs_ind2, aes(x = avg_log2FC, y = -log10(p_val))) +
...
```{r volcano_strain, warning=FALSE}
for (i in cell_types) {
  ind1_vs_ind2 <- read.delim(paste0("../results/DEGs/MAST/", i, "_PS19_vs_WT_comparison_0hours_only.txt"))
  ind1_vs_ind2 <- na.omit(ind1_vs_ind2)
  if (!any(ind1_vs_ind2$p_val_adj < 0.01, na.rm = TRUE)) {
    # If there are no significant DEGs, create a volcano plot with all points in gray
    p <- ggplot(data = ind1_vs_ind2, aes(x = avg_log2FC, y = -log10(p_val))) +
...
write.xlsx(list_of_datasets, file = paste0(
    "../results/DEGs/MAST/3_vs_0_hours_qval0.01_up_regulated.xlsx"))
...
write.xlsx(list_of_datasets, file = paste0(
    "../results/DEGs/MAST/3_vs_0_hours_qval0.01_down_regulated.xlsx"))
...
write.xlsx(list_of_datasets, file = paste0(
    "../results/DEGs/MAST/3_vs_0_hours_qval0.01_up_regulated_PS19_only.xlsx"))
...
write.xlsx(list_of_datasets, file = paste0(
    "../results/DEGs/MAST/3_vs_0_hours_qval0.01_down_regulated_PS19_only.xlsx"))
...
write.xlsx(list_of_datasets, file = paste0(
    "../results/DEGs/MAST/3_vs_0_hours_qval0.01_up_regulated_WT_only.xlsx"))
...
write.xlsx(list_of_datasets, file = paste0(
    "../results/DEGs/MAST/3_vs_0_hours_qval0.01_down_regulated_WT_only.xlsx"))
```
...
write.xlsx(list_of_datasets, file = paste0(
    "../results/DEGs/MAST/PS19_vs_WT_qval0.01_up_regulated.xlsx"))
...
write.xlsx(list_of_datasets, file = paste0(
    "../results/DEGs/MAST/PS19_vs_WT_qval0.01_down_regulated.xlsx"))
...
write.xlsx(list_of_datasets, file = paste0(
    "../results/DEGs/MAST/PS19_vs_WT_qval0.01_up_regulated_3hours_only.xlsx"))
...
write.xlsx(list_of_datasets, file = paste0(
    "../results/DEGs/MAST/PS19_vs_WT_qval0.01_down_regulated_3hours_only.xlsx"))
...
write.xlsx(list_of_datasets, file = paste0(
    "../results/DEGs/MAST/PS19_vs_WT_qval0.01_up_regulated_0hours_only.xlsx"))
...
write.xlsx(list_of_datasets, file = paste0(
  "../results/DEGs/MAST/PS19_vs_WT_qval0.01_down_regulated_0hours_only.xlsx"))
```
