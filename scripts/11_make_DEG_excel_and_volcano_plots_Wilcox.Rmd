...
for (i in cell_types) {
  ind1_vs_ind2 <- read.delim(paste0("../results/DEGs/Wilcox/", i, "_3_vs_0_hours_comparison.txt"))
  ind1_vs_ind2 <- na.omit(ind1_vs_ind2)
  if (!any(ind1_vs_ind2$p_val_adj < 0.01, na.rm = TRUE)) {
    ...
    pdf(paste0("../results/volcanoes/Wilcox/", i, "_3_vs_0hours_all_samples.pdf"), height = 8, width = 8)
    print(p)
    dev.off()
  } else {
    color_values <- vector()
...
for (i in cell_types) {
  ind1_vs_ind2 <- read.delim(paste0("../results/DEGs/Wilcox/", i, "_3_vs_0_hours_comparison_XX_female_only.txt"))
  ind1_vs_ind2 <- na.omit(ind1_vs_ind2)
  if (!any(ind1_vs_ind2$p_val_adj < 0.01, na.rm = TRUE)) {
    # If there are no significant DEGs, create a volcano plot with all points in gray
    p <- ggplot(data = ind1_vs_ind2, aes(x = avg_log2FC, y = -log10(p_val))) +
    ...
    pdf(paste0("../results/volcanoes/Wilcox/", i, "_3_vs_0hours_XX_female_only.pdf"), height = 8, width = 8)
    print(p)
    dev.off()
  } else {
    color_values <- vector()
...
for (i in cell_types) {
  ind1_vs_ind2 <- read.delim(paste0("../results/DEGs/Wilcox/",i,  "_3_vs_0_hours_comparison_XY_male_only.txt"))
  ind1_vs_ind2 <- na.omit(ind1_vs_ind2)
  if (!any(ind1_vs_ind2$p_val_adj < 0.01, na.rm = TRUE)) {
    # If there are no significant DEGs, create a volcano plot with all points in gray
    p <- ggplot(data = ind1_vs_ind2, aes(x = avg_log2FC, y = -log10(p_val))) +
    ...
    pdf(paste0("../results/volcanoes/Wilcox/", i, "_3_vs_0hours_XY_male_only.pdf"), height = 8, width = 8)
    print(p)
    dev.off()
  } else {
    color_values <- vector()
...
for (i in cell_types) {
  ind1_vs_ind2 <- read.delim(paste0("../results/DEGs/Wilcox/",i,  "_3_vs_0_hours_comparison_PS19_only.txt"))
  ind1_vs_ind2 <- na.omit(ind1_vs_ind2)
  if (!any(ind1_vs_ind2$p_val_adj < 0.01, na.rm = TRUE)) {
    # If there are no significant DEGs, create a volcano plot with all points in gray
    p <- ggplot(data = ind1_vs_ind2, aes(x = avg_log2FC, y = -log10(p_val))) +
    ...
    pdf(paste0("../results/volcanoes/Wilcox/", i, "_3_vs_0hours_PS19_only.pdf"), height = 8, width = 8)
    print(p)
    dev.off()
  } else {
    color_values <- vector()
...
for (i in cell_types) {
  ind1_vs_ind2 <- read.delim(paste0("../results/DEGs/Wilcox/",i,  "_3_vs_0_hours_comparison_WT_only.txt"))
  ind1_vs_ind2 <- na.omit(ind1_vs_ind2)
  if (!any(ind1_vs_ind2$p_val_adj < 0.01, na.rm = TRUE)) {
    # If there are no significant DEGs, create a volcano plot with all points in gray
    p <- ggplot(data = ind1_vs_ind2, aes(x = avg_log2FC, y = -log10(p_val))) +
    ...
    pdf(paste0("../results/volcanoes/Wilcox/", i, "_3_vs_0hours_WT_only.pdf"), height = 8, width = 8)
    print(p)
    dev.off()
  } else {
    color_values <- vector()
...
for (i in cell_types) {
  ind1_vs_ind2 <- read.delim(paste0("../results/DEGs/Wilcox/", i, "_PS19_vs_WT_comparison.txt"))
  ind1_vs_ind2 <- na.omit(ind1_vs_ind2)
  if (!any(ind1_vs_ind2$p_val_adj < 0.01, na.rm = TRUE)) {
    # If there are no significant DEGs, create a volcano plot with all points in gray
    p <- ggplot(data = ind1_vs_ind2, aes(x = avg_log2FC, y = -log10(p_val))) +
    ...
    pdf(paste0("../results/volcanoes/Wilcox/", i, "_PS19_vs_WT_all_samples.pdf"), height = 8, width = 8)
    print(p)
    dev.off()
  } else {
    color_values <- vector()
...
```{r volcano_strain, warning=FALSE}
for (i in cell_types) {
  ind1_vs_ind2 <- read.delim(paste0("../results/DEGs/Wilcox/", i, "_PS19_vs_WT_comparison_3hours_only.txt"))
  ind1_vs_ind2 <- na.omit(ind1_vs_ind2)
  if (!any(ind1_vs_ind2$p_val_adj < 0.01, na.rm = TRUE)) {
    # If there are no significant DEGs, create a volcano plot with all points in gray
    p <- ggplot(data = ind1_vs_ind2, aes(x = avg_log2FC, y = -log10(p_val))) +
    ...
    pdf(paste0("../results/volcanoes/Wilcox/", i, "_PS19_vs_WT_3hours_only.pdf"), height = 8, width = 8)
    print(p)
    dev.off()
  } else {
    color_values <- vector()
...
```{r volcano_strain, warning=FALSE}
for (i in cell_types) {
  ind1_vs_ind2 <- read.delim(paste0("../results/DEGs/Wilcox/", i, "_PS19_vs_WT_comparison_0hours_only.txt"))
  ind1_vs_ind2 <- na.omit(ind1_vs_ind2)
  if (!any(ind1_vs_ind2$p_val_adj < 0.01, na.rm = TRUE)) {
    # If there are no significant DEGs, create a volcano plot with all points in gray
    p <- ggplot(data = ind1_vs_ind2, aes(x = avg_log2FC, y = -log10(p_val))) +
    ...
    pdf(paste0("../results/volcanoes/Wilcox/", i, "_PS19_vs_WT_0hours_only.pdf"), height = 8, width = 8)
    print(p)
    dev.off()
  } else {
    color_values <- vector()
...
# All samples 
for (i in cell_types) {
  filepath <- paste0("../results/DEGs/Wilcox/", i, "_3_vs_0_hours_comparison.txt")
...
write.xlsx(list_of_datasets, file = paste0(
    "../results/DEGs/Wilcox/3_vs_0_hours.xlsx"))
...
# WT only 
for (i in cell_types) {
  filepath <- paste0("../results/DEGs/Wilcox/", i, "_3_vs_0_hours_comparison_WT_only.txt")
  assign(paste0(i), read.delim(filepath, header = TRUE, sep = "\t", stringsAsFactors = FALSE))
}
...
"microglia" = microglia)
write.xlsx(list_of_datasets, file = paste0(
    "../results/DEGs/Wilcox/3_vs_0_hours_WT_only.xlsx"))
...
# PS19 only 
for (i in cell_types) {
  filepath <- paste0("../results/DEGs/Wilcox/", i, "_3_vs_0_hours_comparison_PS19_only.txt")
  assign(paste0(i), read.delim(filepath, header = TRUE, sep = "\t", stringsAsFactors = FALSE))
}
...
"microglia" = microglia)
write.xlsx(list_of_datasets, file = paste0(
    "../results/DEGs/Wilcox/3_vs_0_hours_PS19_only.xlsx"))
...
# All samples 
for (i in cell_types) {
  filepath <- paste0("../results/DEGs/Wilcox/", i, "_PS19_vs_WT_comparison.txt")
  assign(paste0(i), read.delim(filepath, header = TRUE, sep = "\t", stringsAsFactors = FALSE))
}
...
"microglia" = microglia)
write.xlsx(list_of_datasets, file = paste0(
    "../results/DEGs/Wilcox/PS19_vs_WT.xlsx"))
...
# WT only 
for (i in cell_types) {
  filepath <- paste0("../results/DEGs/Wilcox/", i, "_PS19_vs_WT_comparison_3hours_only.txt")
  assign(paste0(i), read.delim(filepath, header = TRUE, sep = "\t", stringsAsFactors = FALSE))
}
...
"microglia" = microglia)
write.xlsx(list_of_datasets, file = paste0(
    "../results/DEGs/Wilcox/PS19_vs_WT_3hours_only.xlsx"))
...
# 0 hours only 
for (i in cell_types) {
  filepath <- paste0("../results/DEGs/Wilcox/", i, "_PS19_vs_WT_comparison_0hours_only.txt")
  assign(paste0(i), read.delim(filepath, header = TRUE, sep = "\t", stringsAsFactors = FALSE))
}
...
"microglia" = microglia)
write.xlsx(list_of_datasets, file = paste0(
    "../results/DEGs/Wilcox/PS19_vs_WT_0hours_only.xlsx"))
...
for (i in cell_types) {
  ...
  filtered_dataset <- subset(dataset, p_val_adj < 0.01 & avg_log2FC > 0.0)
  list_of_datasets[[i]] <- filtered_dataset
}
write.xlsx(list_of_datasets, file = paste0(
    "../results/DEGs/Wilcox/3_vs_0_hours_qval0.01_up_regulated.xlsx"))
...
write.xlsx(list_of_datasets, file = paste0(
    "../results/DEGs/Wilcox/3_vs_0_hours_qval0.01_down_regulated.xlsx"))
...
write.xlsx(list_of_datasets, file = paste0(
    "../results/DEGs/Wilcox/3_vs_0_hours_qval0.01_up_regulated_PS19_only.xlsx"))
...
write.xlsx(list_of_datasets, file = paste0(
    "../results/DEGs/Wilcox/3_vs_0_hours_qval0.01_down_regulated_PS19_only.xlsx"))
...
write.xlsx(list_of_datasets, file = paste0(
    "../results/DEGs/Wilcox/3_vs_0_hours_qval0.01_up_regulated_WT_only.xlsx"))
...
write.xlsx(list_of_datasets, file = paste0(
    "../results/DEGs/Wilcox/3_vs_0_hours_qval0.01_down_regulated_WT_only.xlsx"))
```
...
write.xlsx(list_of_datasets, file = paste0(
    "../results/DEGs/Wilcox/PS19_vs_WT_qval0.01_up_regulated.xlsx"))
...
write.xlsx(list_of_datasets, file = paste0(
    "../results/DEGs/Wilcox/PS19_vs_WT_qval0.01_down_regulated.xlsx"))
...
write.xlsx(list_of_datasets, file = paste0(
    "../results/DEGs/Wilcox/PS19_vs_WT_qval0.01_up_regulated_3hours_only.xlsx"))
...
write.xlsx(list_of_datasets, file = paste0(
    "../results/DEGs/Wilcox/PS19_vs_WT_qval0.01_down_regulated_3hours_only.xlsx"))
...
write.xlsx(list_of_datasets, file = paste0(
    "../results/DEGs/Wilcox/PS19_vs_WT_qval0.01_up_regulated_0hours_only.xlsx"))
...
write.xlsx(list_of_datasets, file = paste0(
  "../results/DEGs/Wilcox/PS19_vs_WT_qval0.01_down_regulated_0hours_only.xlsx"))
```
...
count_DE_genes <- function(data) {
  return(sum(data$p_val_adj < 0.01 & abs(data$avg_log2FC) > 0, na.rm = TRUE))
}

# Loop through each cell type
for (cell_type in cell_types) {
  # File paths
  all_samples_file <- paste0("../results/DEGs/Wilcox/", cell_type, "_PS19_vs_WT_comparison.txt")
  hours_0_file <- paste0("../results/DEGs/Wilcox/", cell_type, "_PS19_vs_WT_comparison_0hours_only.txt")
  hours_3_file <- paste0("../results/DEGs/Wilcox/", cell_type, "_PS19_vs_WT_comparison_3hours_only.txt")
...
for (cell_type in cell_types) {
  # File paths
  all_samples_file <- paste0("../results/DEGs/Wilcox/", cell_type, "_3_vs_0_hours_comparison.txt")
  XX_file <- paste0("../results/DEGs/Wilcox/", cell_type, "_3_vs_0_hours_comparison_XX_female_only.txt")
  XY_file <- paste0("../results/DEGs/Wilcox/", cell_type, "_3_vs_0_hours_comparison_XY_male_only.txt")
...
for (cell_type in cell_types) {
  # File paths
  all_samples_file <- paste0("../results/DEGs/Wilcox/", cell_type, "_3_vs_0_hours_comparison.txt")
  PS19_file <- paste0("../results/DEGs/Wilcox/", cell_type, "_3_vs_0_hours_comparison_PS19_only.txt")
  WT_file <- paste0("../results/DEGs/Wilcox/", cell_type, "_3_vs_0_hours_comparison_WT_only.txt")
