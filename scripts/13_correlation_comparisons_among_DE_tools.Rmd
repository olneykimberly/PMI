...
for (cell_type in cell_types) {
  for (time_point in time_points) {
    ...
    file_name <- paste0("../results/DEGs/DESeq2_pseudobulk/", cell_type, "_PS19_vs_WT_comparison_", time_point, "_only.txt")
...
dataObject.pseudo$time
dot_ind <- DotPlot(dataObject.pseudo,
...
pdf(
  paste0(
    "../results/dot_plot/",
    treatment,
    "_individual_clusters_clean_group_no_sex.pdf"
  ),width = 11, height = 9.5)
dot_ind
dev.off()
```
