...
aov_result <- aov(frequency ~ group, data = data2)
summary(aov_result)

library(car)  # For Levene's Test

# Perform ANOVA
anova_result <- aov(frequency ~ group, data = data2)
...
leveneTest(frequency ~ group, data = data2)
...
cellcyle <- dataObject@meta.data %>%
  ...
  scale_fill_manual(values = c("gray", "maroon", "gold3"))
cellcyle
