---
title: "PMI - mice rep 1 vs. rep 2 3hour"
...
pathToTestType <- "scRNA/cell_rep_1_vs_rep_2/"
tissue <- "Brain"
seqType <- "Cell"
treatment <- "PMI"
tool <- "cellbender"
...
# contrast
myContrasts <- c("replicate 1 - replicate 2")
```
...
if (tissue == "Brain" && file.exists(paste0("../../rObjects/", pathToTestType, "PMI_merged_h5.rds"))) {
  ...
  saveRDS(PMI, past0("../../rObjects/", pathToTestType, "PMI_merged_h5.rds"))
} 
...
denCount
path <- paste0("../../results/", pathToTestType, "density/",treatment,"_",tolower(tissue),"_nCount_raw")
saveToPDF(paste0(path, ".pdf"), width = 6, height = 4)
saveToPNG(paste0(path, ".png"), width = 6, height = 4, unit = "in", res = 300)
dev.off()

denMt
path <- paste0("../../results/", pathToTestType, "density/",treatment,"_",tolower(tissue),"_percent.Mt_raw")
saveToPDF(paste0(path, ".pdf"), width = 8, height = 4)
saveToPNG(paste0(path, ".png"), width = 6, height = 4, unit = "in", res = 300)
dev.off()

denCellComplexity
path <- paste0("../../results/", pathToTestType, "density/",treatment,"_",tolower(tissue),"_cell_complexity_raw")
saveToPDF(paste0(path, ".pdf"), width = 6, height = 4)
saveToPNG(paste0(path, ".png"), width = 6, height = 4, unit = "in", res = 300)
dev.off()

denTtr
path <- paste0("../../results/", pathToTestType, "density/",treatment,"_",tolower(tissue),"_percent.Ttr_raw")
saveToPDF(paste0(path, ".pdf"), width = 6, height = 4)
saveToPNG(paste0(path, ".png"), width = 6, height = 4, unit = "in", res = 300)
dev.off()

denXist
path <- paste0("../../results/", pathToTestType, "density/",treatment,"_",tolower(tissue),"_percent.Xist_raw")
saveToPDF(paste0(path, ".pdf"), width = 6, height = 4)
saveToPNG(paste0(path, ".png"), width = 6, height = 4, unit = "in", res = 300)
dev.off()

denDdx3x
path <- paste0("../../results/", pathToTestType, "density/",treatment,"_",tolower(tissue),"_percent.Ddx3x_raw")
saveToPDF(paste0(path, ".pdf"), width = 6, height = 4)
saveToPNG(paste0(path, ".png"), width = 6, height = 4, unit = "in", res = 300)
dev.off()

denApoe
path <- paste0("../../results/", pathToTestType, "density/",treatment,"_",tolower(tissue),"_percent.Apoe_raw")
saveToPDF(paste0(path, ".pdf"), width = 6, height = 4)
saveToPNG(paste0(path, ".png"), width = 6, height = 4, unit = "in", res = 300)
dev.off()
```
...
vGenes <- VlnPlot(PMI,
              features = c("percent.Xist", "percent.Ddx3x", "percent.Ttr", "percent.Apoe"),
              ncol = 4,
              group.by = 'sample',
              cols = sample_colors,
              pt.size = 0)
...
# save v1
vCellInfo
path <- paste0("../../results/", pathToTestType, "vlnPlots/",treatment,"_",tolower(tissue),"_nFeature_nCount_complexity_raw")
saveToPDF(paste0(path, ".pdf"), width = 6, height = 4)
saveToPNG(paste0(path, ".png"), width = 6, height = 4, unit = "in", res = 300)
dev.off()
...
# save v2
vMtRiboHb
path <- paste0("../../results/", pathToTestType, "vlnPlots/",treatment,"_",tolower(tissue),"_percent_raw")
saveToPDF(paste0(path, ".pdf"), width = 8, height = 4)
saveToPNG(paste0(path, ".png"), width = 6, height = 4, unit = "in", res = 300)
dev.off()
...
# save vXist
vXist
path <- paste0("../../results/", pathToTestType, "vlnPlots/",treatment,"_",tolower(tissue),"_percent_raw_Xist")
saveToPDF(paste0(path, ".pdf"), width = 6, height = 4)
saveToPNG(paste0(path, ".png"), width = 6, height = 4, unit = "in", res = 300)
dev.off()
...
# save vXist
vGenes
path <- paste0("../../results/", pathToTestType, "vlnPlots/",treatment,"_",tolower(tissue),"_percent_raw_Xist_Ddx3x_Ttr_Apoe")
saveToPDF(paste0(path, ".pdf"), width = 6, height = 4)
saveToPNG(paste0(path, ".png"), width = 6, height = 4, unit = "in", res = 300)
dev.off()
# cleanup
remove(vCellInfo, vMtRiboHb, vXist, vDdx3x, vTtr, vApoe, vGenes)
```
...
# save
sMt
path <- paste0("../../results/", pathToTestType, "scatterPlots/",treatment,"_",tolower(tissue),"_nFeature_vs_nCount_raw")
...
# save
sMt
path <- paste0("../../results/", pathToTestType, "scatterPlots/",treatment,"_",tolower(tissue),"_nCount_vs_percentMT_raw")
saveToPDF(paste0(path, ".pdf"), width = 4, height = 4)
saveToPNG(paste0(path, ".png"), width = 4, height = 4, unit = "in", res = 300)
dev.off()

# cleanup
remove(sMt, sTtr, sTtrMt, sXist)
```
...
for (i in 1:length(PMI.split)) {
  ...
  d1 <- DimPlot(PMI_sample,
        ...
        label = TRUE,
        label.size = 6)
  path <- paste0("../../results/", pathToTestType, "doubletFinder/",treatment,"_",tolower(tissue),
  ...
  write.table(table(DF_class), paste0("../../results/", pathToTestType, "doubletFinder/",treatment,"_",tolower(tissue),
  ...
  write.table(ncells_per_cluster, paste0(
    "../../results/", pathToTestType, "doubletFinder/",treatment,"_",tolower(tissue),
...
PMI.filtered$replicate <- factor(PMI.filtered$replicate,
                                 levels = c("replicate1","replicate2"))
...
```{r,echo=FALSE}
saveRDS(PMI.filtered, paste0("../../rObjects/", pathToTestType, tolower(tissue),"_filtered.rds"))
PMI.filtered <- readRDS(paste0("../../rObjects/", pathToTestType, tolower(tissue),"_filtered.rds"))
...
```{r,echo=FALSE,eval=FALSE}
# cleanup
remove(log2.threshold,counts.df,log2.counts.df, hist1,hist2,plots,layout,grid)
```
...
# save
grid <- grid.arrange(grobs = plots, layout_matrix = layout)
path <- paste0("../../results/", pathToTestType, "nCells/",treatment,"_",tolower(tissue), 
               "_cells_per_sample")
saveToPDF(paste0(path, ".pdf"), width = 6, height = 4)
saveToPNG(paste0(path, ".png"), width = 6, height = 4, unit = "in", res = 300)
dev.off()
...
# cleanup
remove(ncellsRaw, ncellsFiltered, plots, layout, grid)
```
## Density plots 
```{r postfiltering_density_cellinfo}
# set graphical parameter
par(mfrow = c(3,1))
...
# Arrange graphs in grid
plots <- list(denCount,denMt,denCellComplexity,denCount_filter,denMt_filter,denCellComplexity_filter)
...
# save
grid_den_raw_filter <- grid.arrange(grobs = plots, layout_matrix = layout)
path <- paste0("../../results/", pathToTestType, "density/",treatment,"_",tolower(tissue), 
               "_density")
saveToPDF(paste0(path, ".pdf"), width = 6, height = 4)
saveToPNG(paste0(path, ".png"), width = 6, height = 4, unit = "in", res = 300)
dev.off()
...
# cleanup
remove(denCount,denMt,denCellComplexity,
       denCount_filter,denMt_filter,denCellComplexity_filter,
       layout, plots, grid_den_raw_filter)
```

Density plots for genes of interest
```{r postfiltering_density_genes}
# set graphical parameter
par(mfrow = c(4,1))
...
# Arrange graphs in grid
plots <- list(denApoe, denXist, denDdx3x, denTtr,  denApoe_filter, denXist_filter, denDdx3x_filter, denTtr_filter)
...
grid_den_raw_filter_genes <- grid.arrange(grobs = plots, layout_matrix = layout)
path <- paste0("../../results/", pathToTestType, "density/",treatment,"_",tolower(tissue), 
               "_density_percent_genes")
saveToPDF(paste0(path, ".pdf"), width = 6, height = 4)
saveToPNG(paste0(path, ".png"), width = 6, height = 4, unit = "in", res = 300)
dev.off()

# cleanup
remove(denApoe,denApoe_filter,denDdx3x,
       denDdx3x_filter,denTtr,denTtr_filter,denXist, denXist_filter,
       layout, plots, grid_den_raw_filter_genes)
```
...
# save v1
vCellInfo
path <- paste0("../../results/", pathToTestType, "vlnPlots/",treatment,"_",tolower(tissue),"_nFeature_nCount_complexity_filtered")
saveToPDF(paste0(path, ".pdf"), width = 6, height = 4)
saveToPNG(paste0(path, ".png"), width = 6, height = 4, unit = "in", res = 300)
dev.off()
...
# save v2
vMtRiboHb
path <- paste0("../../results/", pathToTestType, "vlnPlots/",treatment,"_",tolower(tissue),"_percent_filtered")
saveToPDF(paste0(path, ".pdf"), width = 8, height = 4)
saveToPNG(paste0(path, ".png"), width = 6, height = 4, unit = "in", res = 300)
dev.off()
...
# save vXist
vXist
path <- paste0("../../results/", pathToTestType, "vlnPlots/",treatment,"_",tolower(tissue),"_percent_filtered_Xist")
saveToPDF(paste0(path, ".pdf"), width = 6, height = 4)
saveToPNG(paste0(path, ".png"), width = 6, height = 4, unit = "in", res = 300)
dev.off()
...
# save
sMt
path <- paste0("../../results/", pathToTestType, "scatterPlots/",treatment,"_",tolower(tissue),
...
# save
b1
path <- paste0("../../results/", pathToTestType,"boxPlots/",treatment,"_",tolower(tissue),
...
```{r,echo=FALSE,eval=FALSE}
write.table(df, paste0("../../results/", pathToTestType,"topTranscripts/", tolower(tissue), "_abundant_transcripts.txt"),
            quote = FALSE,
            row.names = FALSE)
```
...
# save
cellcyclecount_barplot
path <- paste0("../../results/", pathToTestType,"cellCycle/",treatment,"_",tolower(tissue),
               "_cellcycle_bargraph")
saveToPDF(paste0(path, ".pdf"), width = 4, height = 4)
saveToPNG(paste0(path, ".png"), width = 4, height = 4, unit = "in", res = 300)
dev.off()
...
saveRDS(PMI.sct.merged, paste0("../../rObjects/",pathToTestType, tolower(tissue), "_PMI.sct.merged.rds"))
PMI.sct.merged <- readRDS(paste0("../../rObjects/",pathToTestType, tolower(tissue), "_PMI.sct.merged.rds"))
```
insepct data 
```{r}
...
```{r,echo=FALSE,eval=FALSE,message=FALSE,warning=FALSE}
path <- paste0("../../results/", pathToTestType, "PCA/",treatment,"_",tolower(tissue),
               "_PCA_treatment")
pcaTreatment
saveToPDF(paste0(path, ".pdf"), width = 4, height = 4)
saveToPNG(paste0(path, ".png"), width = 4, height = 4, unit = "in", res = 300)
...
dev.off()
# cleanup
remove(pcaTreatment, pcaReplicate, pcaSampleSplit, pcaSample, pcaGenotype)
```
...
saveRDS(PMI.integrated, paste0("../../rObjects/", pathToTestType, tolower(tissue),"_preclustering.rds"))
PMI.integrated <- readRDS(paste0("../../rObjects/", pathToTestType, tolower(tissue),"_preclustering.rds"#))
```
...
saveRDS(PMI.unannotated, paste0("../../rObjects/", pathToTestType, tolower(tissue), "_unannotated.rds"))
PMI.unannotated <- readRDS(paste0("../../rObjects/", pathToTestType, tolower(tissue), "_unannotated.rds"))
```
...
```{r,echo=FALSE,eval=FALSE,message=FALSE,warning=FALSE}
# save umap0.1
path <- paste0("../../results/", pathToTestType, "/UMAP/unannotated/",treatment,"_",tolower(tissue),
...
```{r,echo=FALSE,eval=FALSE,message=FALSE,warning=FALSE}
# save
path <- paste0("../../results/", pathToTestType, "featurePlots/",treatment,"_",tolower(tissue),
