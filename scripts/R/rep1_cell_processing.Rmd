...
```{r seurat_object}
prefix <- "/research/labs/neurology/fryer/shared/PMI_old_scripts/OLD_SCRIPTS/PMI_data/"
...
if (tissue == "Brain" && file.exists("../../rObjects/cell_replicate_1_merged_h5.rds")) {
  ...
  WT_0_hr <- CreateSeuratObject(Read10X_h5(paste0(prefix,"Wt_Fresh",suffix)))
  ...
  PS19_0_hr <- CreateSeuratObject(Read10X_h5(paste0(prefix,"PS19_Fresh",suffix)))
