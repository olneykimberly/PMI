...
outfile = open('nucleus_config.json', 'w')
...
header = '''{{
    ...
    "rawReads" : "/research/labs/neurology/fryer/projects/PMI/snRNA/",
    "counts" : "../../counts/",
    "cellbender" : "../../cellbender/",
    "results" : "../../results/",
    "rObjects" : "../../rObjects/",
    "fastq_path" : "/research/labs/neurology/fryer/projects/PMI/snRNA/",
...
with open('sampleReadGroupInfo_snRNA.txt', 'r') as infile:
    for line in infile:
        ...
        out = '''
    "{0}":{{
        "fq_path": "/research/labs/neurology/fryer/projects/PMI/snRNA/",
        "fq1": "{1}",
        "fq2": "{2}",
        "shortName1": "{3}",
        "shortName2": "{4}",
